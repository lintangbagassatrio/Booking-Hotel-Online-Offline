...
Route::get('/landingpage/detail/success', function () {
    return view('success');
...
Route::post('landingpage/detail/success', [\App\Http\Controllers\AdminController::class, 'submit_reservasi_user'])->name('user.reservasi.submit')->middleware('auth');
